...
export const BUILDINGS: Building[] = [
  ...
  },
  {
    ...
    name: 'Biblioteca',
    area: 'Conocimiento',
    what: 'Guarda lo que aprendes: temas estudiados, repasos hechos y apuntes escritos.',
    ...
    scoring: ['1 punto por tema completado', '1 punto por repaso superado', '3 puntos por tema dominado (4 repasos)', '1 punto por apunte escrito'],
    tip: 'Completa temas, repasa tus flashcards y escribe lo que aprendes.',
    to: '/apuntes',
    cta: 'Ir a mis apuntes',
    measure: (s) => s.topicsDone + s.reviews + s.mastered * 3 + s.notes,
  },
  {
    id: 'academia',
    name: 'Academia',
  ...
  },
  {
    id: 'museo',
    name: 'Museo',
    area: 'Logros y certificaciones',
    what: 'Expone tus trofeos: tus logros y las certificaciones que consigues.',
    unit: 'piezas',
    thresholds: [3, 8, 16, 28, 40],
    levelNames: ['Vitrina', 'Sala de honor', 'Museo', 'Gran museo', 'Palacio de los récords'],
    scoring: ['1 punto por cada logro desbloqueado', '1 punto por cada certificación que registras'],
    tip: 'Registra tus certificados: cada uno es una pieza más de la exposición.',
    to: '/certificaciones',
    cta: 'Ver mis certificaciones',
    measure: (s) => s.achievementsCount + s.certifications,
  },
];
